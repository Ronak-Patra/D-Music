...
export default function TabLayout() {
  ...
  const tabTheme = useMemo(
    () => ({
      ...
      active: (dynamicColorsEnabled && songColor) ? songColor : (isDark ? (isIOS ? '#038434' : '#1DB954') : '#167c3a'),
      inactive: isDark ? (isIOS ? '#646464' : '#9a9a9a') : '#7a6251',
      safeArea: isDark ? '#000000' : '#ffffff',
    }),
    [isDark, isIOS, dynamicColorsEnabled, songColor]
  );
